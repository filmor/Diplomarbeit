...
V(0) + W(0)$. % TODO Anständig umschreiben was passiert
...
\begin{Lemma}
  ...
  \begin{Proof}
    ...
    Appendix~\ref{app:gamma} (\thref{lem:incomplete-gamma}).
    % TODO
    ...
    % TODO: Zeigen, dass der Term nicht beiträgt!
    %       Hier stimmt irgendwas noch nicht, die Integrationen muss ich nach-
    %       prüfen.
...
\begin{MainTheorem}
  ...
  \end{Remark}
  \begin{Remark}
    % TODO: Zeigen, dass der gleiche Kram wie oben gilt, mit einfach
    % verringerter Ordnung (weil hier einmal mehr integriert ist)
  \end{Remark}
  \begin{Proof}
    ...
    % TODO: Genauer ansehen, welche Terme am Ende beitragen, indem wir \mu- und
    % Polynomordnung nachhalten (die müsste gleich sein!)
  \end{Proof}
\end{MainTheorem}
